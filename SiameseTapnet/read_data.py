...
def get_data():
    failObs_path = 'data/failObs.txt'
    successObs_path = 'data/successObs.txt'
...
def get_data_siamese2(x, labels, idx_train, idx_val, idx_test):
    ...
    # test:
    bench_noCrash0 = noCrash_train[0]
    bench_noCrash1 = noCrash_train[10]
    bench_noCrash2 = noCrash_train[20]
    bench_crash = crash_train[0]

    bench_noCrash = bench_noCrash0

    print('bench_noCrash0: ')
    print(bench_noCrash0)
    print('bench_noCrash1: ')
    print(bench_noCrash1)
    print('bench_noCrash2: ')
    print(bench_noCrash2)
    print('bench_crash: ')
    print(bench_crash)
